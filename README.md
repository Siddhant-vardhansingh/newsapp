...
#### `git clone https://github.com/Siddhant-vardhansingh/newsapp.git`

### Install the dependencies and Dev Dependencies

#### `npm install`

#### Now get the apikey by signing in to <a href="www.newsapp.org">Newapi</a>. Paste the apikey generated by the nesapi in the app.js
...
#### <a href="https://youtu.be/WnqeCXMs5FI"></a>
